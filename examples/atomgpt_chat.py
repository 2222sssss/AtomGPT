...
with gr.Blocks() as demo:
    gr.Markdown("""<h1><center>助手——AtomGPT</center></h1>""")
    chatbot = gr.Chatbot([(None,'您好，我是AtomGPT(阿童木)，是由原子回声训练和开发的语言模型，用来回答用户问题的人工智能助手。非常高兴认识您，您有问题或者需求都可以直接向我提问，我会利用我的能力来为您解答。')])
    msg = gr.Textbox()
    state = gr.State()
    with gr.Row():
        clear = gr.Button("新话题")
    ...
    clear.click(lambda: [(None,'您好，我是AtomGPT(阿童木)，是由原子回声训练和开发的语言模型，用来回答用户问题的人工智能助手。非常高兴认识您，您有问题或者需求都可以直接向我提问，我会利用我的能力来为您解答。')], None, chatbot, queue=False)

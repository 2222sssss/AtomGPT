...
The pre-training process continues…
...
- Data from Wikipedia’s Chinese version
- 200GB of open source data called “WuDao.”"
...
```
The 4bit model is loaded as if it’s needed. --is_4bit

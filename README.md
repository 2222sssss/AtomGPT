...
### Chat模型更新
- 2023.07.24 开放出在第56000步的预训练模型基础上，通过lora进行指令微调指令对话模型
...
AtomGPT_56k_chat_4bit|AtomEchoAI/AtomGPT_56k_chat_4bit|[模型下载(量化后效果下降较多，正在重新量化)](https://huggingface.co/AtomEchoAI/AtomGPT_56k_chat_4bit)
